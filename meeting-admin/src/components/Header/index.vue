 ...
 * @LastEditTime: 2023-03-20 13:59:56
-->
<template>
  <div id="Header">
    <el-col :xs="14" :sm="12" :md="12" :lg="12" :xl="12">
      ...
      <div class="left-panel">
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
          <el-BreadcrumbItem v-for="breaditem in breadList" :to="{path:breaditem.path}">
          {{ breaditem.title }}
      ...
      <div class="right-panel">
        <el-dropdown @command="handleCommand">
          ...
          <span class="avatar-dropdown">
            ...
            <img class="user-avatar" src="https://i.gtimg.cn/club/item/face/img/8/15918_100.gif" alt="" />
            <div class="user-name">
              {{ username }}
